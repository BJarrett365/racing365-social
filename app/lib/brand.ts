...
export const BRAND_HORSE_RACING_FOLLOW = `Follow ${BRAND_HORSE_RACING_MARK}`;
...
/** Product slogan shown in brand header blocks. */
export const BRAND_SLOGAN = "Create, layer and deliver content at scale";

/** Primary positioning line (hero, meta description). */
